...
#To remove Nov data
group_countries_transposed <- group_countries_transposed[-c(11), ]


#To sum all cases by months
group_countries_transposed$Case_sum <- rowSums(group_countries_transposed[2:191])
...
group_countries_transposed

total_cases_chart <- ggplot(group_countries_transposed, aes(x=Month, y=Millions_of_cases)) + geom_bar(stat='identity', fill='steelblue') + labs(title='Total cases from Jan to Oct 2020') + ylab(label='Millions of cases') + scale_x_discrete(limit = c('Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct')) + theme(text = element_text(size=10), axis.title.x=element_blank()) 
...
us_confirmed_chart <- ggplot(us_confirmed_case_by_month, aes(x=month, y=million_cases)) + geom_bar(stat='identity', fill='steelblue') + labs(title='US cases from Jan to Oct 2020') + ylab(label='Millions of cases') + scale_x_discrete(limit = c('Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct')) + theme_minimal() + theme(text = element_text(size=10), axis.title.x=element_blank()) 
