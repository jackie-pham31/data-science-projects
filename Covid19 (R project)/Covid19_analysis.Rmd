...
us_confirmed_chart <- ggplot(us_confirmed_case_by_month, aes(x=month, y=million_cases)) + geom_bar(stat='identity', fill='steelblue') + labs(title='US cases from 22nd Jan to 9th Oct 2020', subtitle = 'Nov data is not fully updated') + ylab(label='Million of cases') + scale_x_discrete(limit = c('Jan', 'Feb', 'March', 'April', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct')) + theme_minimal() + theme(axis.title.x=element_blank()) 
